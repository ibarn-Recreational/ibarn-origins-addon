...
import com.ibarnstormer.ibarnorigins.mixin.AreaEffectCloudAccessor;
...
public class SoulFireBallEntity extends AbstractHurtingProjectile {
    ...
    public SoulFireBallEntity(LivingEntity owner, Vec3 direction, Level world) {
        super(IOEntities.SOUL_FIRE_BALL_ENTITY.get(), owner, direction, world);
    }
    ...
    protected void onHit(HitResult hitResult) {
        ...
        if (!this.level().isClientSide) {
            ...
            areaEffectCloudEntity.setParticle(IOParticles.SOUL_MAGE_FLAME.get());
            ...
            if(entity instanceof Player player) {
                ...
                if(charged && soulFireStrength.getAmplifier() % 2 == 1 && areaEffectCloudEntity instanceof AreaEffectCloudAccessor access) {
                    access.setReapplicationDelay(15);
                }
    ...
    protected void onHitEntity(EntityHitResult entityHitResult) {
        ...
        if (this.level() instanceof ServerLevel serverLevel) {
            ...
            if(entity2 instanceof Player player) {
                ...
                entity.hurt(entity.damageSources().indirectMagic(this, player), damage / 2);
                entity.hurt(IODamageSources.entityDamageSource("soul_blast", player, this.level()), damage);
                ...
                entity.hurt(entity.damageSources().indirectMagic(this, entity2), 4.0F);
                entity.hurt(IODamageSources.entityDamageSource("soul_blast", entity2, this.level()), 8.0F);
            ...
            if (entity2 instanceof LivingEntity livingEntity) {
                EnchantmentHelper.doPostAttackEffects(serverLevel, livingEntity, entity.damageSources().indirectMagic(this, entity2));
            }
        }
    }
