...
public class IOSounds {
    ...
    public static final ResourceLocation SOUL_BLAST_ID = IbarnOriginsMain.IOIdentifier("soul_blast");
    public static final ResourceLocation KI_BLAST_CHARGE_ID = IbarnOriginsMain.IOIdentifier("ki_blast_charge");
    public static final ResourceLocation KI_BLAST_FIRE_ID = IbarnOriginsMain.IOIdentifier("ki_blast_fire");
