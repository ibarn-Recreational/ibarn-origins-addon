...
public class IOUtils {
    ...
    public static void renderParticles(Level world, LivingEntity entity, ParticleOptions particleEffect) {
        if(world instanceof ClientLevel clientWorld) {
            boolean render = (entity instanceof LocalPlayer player && Minecraft.getInstance().player == player && !(Minecraft.getInstance().options.getCameraType().isFirstPerson() && Minecraft.getInstance().getCameraEntity() == player)) ||
